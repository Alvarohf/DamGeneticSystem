#pragma checksum "D:\github\DamGeneticSystem\GeneticDams\GeneticDams\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a9d9416540ec30ae6d1a00dddcbd4494892085fa"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a9d9416540ec30ae6d1a00dddcbd4494892085fa", @"/Views/Home/Index.cshtml")]
...
");
            ...
            DefineSection("Scripts", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a9d9416540ec30ae6d1a00dddcbd4494892085fa11858", async() => {
                }
                );
    ...
    <script>
        ...
        function floodMap(map, elevation) {
         ...
         ");
                WriteLiteral(@"       var area = google.maps.geometry.spherical.computeArea(polygon);
                console.log(area);
      ...
      ");
                WriteLiteral(@"  function mapJson(map, name) {
            ...
            ");
                WriteLiteral(@"                    position: polyBnds.getCenter()
                            });
                            iW.open(map);
                        }
                    });
  ...
  ");
                WriteLiteral(@"          var msg = message.replace(/&/g, ""&amp;"").replace(/</g, ""&lt;"").replace(/>/g, ""&gt;"");
            document.getElementById(""result"").value = message;

            changeMarkerPosition(mainMarker,locations[0]);
            console.log(message)
        ...
        document.getElementById(""sendButton"").addEventListener(""click"", function (event) {
            ...
            if (MapBounds !== undefined) {
                ...
                connection.invoke(""SendMessage"", typeMessage, message).c");
                WriteLiteral(@"atch(function (err) {
                    return console.error(err.toString());
                });
            } else {
